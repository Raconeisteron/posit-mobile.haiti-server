...
public class DataEntryForm extends JPanel implements ActionListener, KeyListener {
	...
	protected void paintComponent(Graphics g) {
		...
		radioMale.setText(LocaleManager.resources.getString(AttributeManager.FORM_MALE));
		radioFemale.setText(LocaleManager.resources.getString(AttributeManager.FORM_FEMALE));
